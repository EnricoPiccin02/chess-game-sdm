...
public class DefaultLegalMoveFinder implements LegalMoveFinder {

    private final MoveValidator validator;
    private final MoveGenerator generator;
    private final ChessboardOrientation orientation;

    public DefaultLegalMoveFinder(MoveValidator validator, MoveGenerator generator, ChessboardOrientation orientation) {
