package test.chessgame.gui.board.square;
...
import test.chessgame.gui.testdoubles.ChessPieceViewRegistryStub;
import test.chessgame.gui.testdoubles.HighlightRendererSpy;
